...
PLOTS = [
    ...
    ("reversed-sawtooth-signal", "Reversed Sawtooth Signal", lambda values: 2 * np.abs(periodic_remainder(values, 1) - 1) - 1),
    ("triangle-signal", "Triangle Signal", lambda values: triangle(values, 2)),
